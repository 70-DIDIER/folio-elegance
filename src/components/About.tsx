const About = () => {
  return (
    <section id="à-propos" className="py-20 bg-card/50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-primary">À propos de moi</h2>
          <p className="text-lg text-gray-400 mt-2">Mon parcours, ma passion et ce qui me motive.</p>
        </div>
        <div className="max-w-3xl mx-auto bg-background rounded-lg shadow-xl p-8">
