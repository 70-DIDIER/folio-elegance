...
const Hero = () => {
  return (
    <section id="hero" className="relative h-[calc(100vh-4rem)] flex items-center justify-center text-center bg-background">
        ...
        <div className="relative z-10 px-4">
            ...
            <a href="#contact" className="bg-primary hover:bg-primary/90 text-primary-foreground font-bold py-3 px-8 rounded-full transition-transform transform hover:scale-105 text-lg">
                Contactez-moi
            </a>
        </div>
